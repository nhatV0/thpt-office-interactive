  ...
  return (
    <header className="sticky top-0 z-50 w-full bg-white/95 dark:bg-slate-900/95 backdrop-blur border-b border-slate-200 dark:border-slate-800 px-3 sm:px-6 h-14 flex items-center justify-between shadow-xs select-none">
      ...
      <div className="flex items-center gap-2 sm:gap-3">
        {/* Nút Trang Chủ luôn sẵn sàng click */}
        <button
          type="button"
          onClick={onGoHome}
          ...
          title="Về Trang Chủ / Lộ trình học"
        >
        ...
        >
          ...
          <div className="hidden md:block">
            <h1 className="text-xs sm:text-sm font-bold tracking-tight text-slate-900 dark:text-slate-100 leading-none">
              Tin Học Văn Phòng THPT
            </h1>
            <p className="text-[10px] text-slate-500 dark:text-slate-400 mt-0.5">
              Word | Excel | PowerPoint Chuẩn 100%
            </p>
          </div>
        </div>
      </div>

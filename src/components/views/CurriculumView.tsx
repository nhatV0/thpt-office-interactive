...
export const CurriculumView: React.FC<CurriculumViewProps> = ({ onSelectLesson, onOpenPractice }) => {
  ...
  return (
    <div className="max-w-5xl mx-auto p-4 sm:p-8 space-y-8">
      ...
      {/* Callout Card for MOS Word Practice Pack */}
      <div className="p-5 rounded-3xl border-2 border-emerald-500/50 bg-gradient-to-r from-emerald-50 to-teal-50 dark:from-emerald-950/40 dark:to-slate-900/60 shadow-sm flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div className="space-y-1">
          <div className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full bg-emerald-200/80 dark:bg-emerald-900 text-emerald-800 dark:text-emerald-300 text-[11px] font-bold">
            <Sparkles className="w-3.5 h-3.5 text-emerald-600" />
            <span>Dữ Liệu Thực Hành Gốc MOS Word 2019</span>
          </div>
          <h3 className="text-base sm:text-lg font-bold text-slate-900 dark:text-slate-100">
            Luyện Tập Đề Thi Cuối Khóa & Tải Gói Dữ Liệu
          </h3>
          <p className="text-xs text-slate-600 dark:text-slate-400 max-w-2xl leading-relaxed">
            Tải toàn bộ tệp tài liệu bài tập (.docx) về máy tính cá nhân để thực hành thao tác trên Microsoft Word thật. Xem toàn bộ đề thi Multi-Project và đáp án hướng dẫn từng bước online.
          </p>
        </div>
        ...
        <div className="flex items-center gap-2 shrink-0">
          <button
            ...
            className="flex items-center justify-center gap-2 px-5 py-2.5 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-xs shadow-md cursor-pointer transition-all"
          >
            <span>Xem Đề & Tải Bài Tập</span>
